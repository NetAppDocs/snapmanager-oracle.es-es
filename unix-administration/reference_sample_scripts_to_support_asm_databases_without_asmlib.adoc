...
summary: Los scripts de ejemplo están disponibles en el directorio plugins/examples/noasmlib del directorio de instalación de SnapManager para Oracle. 
---
...
[role="lead"]
Los scripts de ejemplo están disponibles en el directorio plugins/examples/noasmlib del directorio de instalación de SnapManager para Oracle.
